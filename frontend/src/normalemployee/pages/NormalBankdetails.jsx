...
const NormalBankdetails = () => {
  ...
  const { fetchApprovedBankDetailById } = useBankdetailStore();
  ...
  useEffect(() => {
    const fetchBankData = async () => {
      ...
      try {
        ...
        const bankData = await fetchApprovedBankDetailById(id);
    ...
    fetchBankData();
  }, [id, fetchApprovedBankDetailById]);

   const handleBack = () => {
    navigate('/normalemployee/normalapproveddocument');
  };
...
export default NormalBankdetails;
