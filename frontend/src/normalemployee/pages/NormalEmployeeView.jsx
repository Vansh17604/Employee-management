...
const NormalEmployeeView = () => {
  ...
  const { fetchApprovedEmployeeById, pendingEmployees } = useEmployeeStore();
  ...
  useEffect(() => {
    const fetchEmployeeData = async () => {
      ...
      try {
        ...
        const employeeData = await fetchApprovedEmployeeById(employeeId);
        if (employeeData) {
    ...
    fetchEmployeeData();
  }, [employeeId, fetchApprovedEmployeeById]);
...
export default NormalEmployeeView;