...
router.put('/editpendingemployee/:id',verifyTokenAndAuthorize('admin'),upload.single('photo'),EmployeController.editEmployeeData);
router.put('/editapproveemployee/:id',verifyTokenAndAuthorize('admin'),upload.single('photo'),EmployeController.editApprovalEmployeeData);
